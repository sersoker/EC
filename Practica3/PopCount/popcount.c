...
int popcount5b(int* array, int len){

    int res=0;
    int i=0;
    volatile int SSE_mask[] = { 0x0f0f0f0f, 0x0f0f0f0f, 0x0f0f0f0f, 0x0f0f0f0f };
    volatile int SSE_LUTb[] = { 0x02010100, 0x03020201, 0x03020201, 0x04030302 };
...
int main(){
    ...
    crono(popcount5b, "popcount5b (Versión 5b     )");
